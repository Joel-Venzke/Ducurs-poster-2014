...
%%CreationDate: Wed Apr  9 10:09:23 2014
%%DocumentFonts: 
...
showpage
  ...
  \put(4089,4739){\makebox(0,0){\strut{}\textbf{2-36-2~~~~$\mathbf{0.25 \times 10^{14}\,}$W/cm$^2$~~~10.2 eV}}}%
  \put(4089,140){\makebox(0,0){\strut{}$E$ [a.u.s]}}%
  \put(160,2589){%
  \special{ps: gsave currentpoint currentpoint translate
630 rotate neg exch neg exch translate}%
  \makebox(0,0){\strut{}$dP/dE$ [a.u.]}%
