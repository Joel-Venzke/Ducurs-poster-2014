...
plot datadir . '/Pulse_s-s_2-36-2-350/pulse.out' u 2:5 t '\tt S-S' w l lt 1 lc 3 lw 2, \
     datadir . '/Pulse_t-t_2-36-2-350/pulse.out' u 2:5 t '\tt L-L' w l lt 1 lc 1 lw 2
set notitle
...
set size 0.32
set nokey
plot datadir . '/Pulse_s-s_2-36-2-350/pulse.out' u 2:($3 *.10676) t '\footnotesize \tt S-S' w l lt 1 lc 3 lw 2,\
     datadir . '/Pulse_t-t_2-36-2-350/pulse.out' u 2:($3 *.10676) t '\footnotesize \tt L-L' w l lt 1 lc 1  lw 2, \
