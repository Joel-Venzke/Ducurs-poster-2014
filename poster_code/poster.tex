...
\vspace{1cm}\begin{center}\pbox{0.8\columnwidth}{}{linewidth=2mm,framearc=0.1,linecolor=lightblue,fillstyle=gradient,
  ...
  \begin{multicols}{2}
  \begin{center}
  \myfig{c_pulse_350_2_36_3.ps}{1.0}
  \end{center}

  \begin{center}
  \myfig{c_pulse_375_2_36_3.ps}{1.0}
  \end{center}
  \end{multicols}
  ...
  \vspace{-2cm}
  \mycaption{LEFT: \textbf{0.350 AU} frequency plot with highest intensity RIGHT: \textbf{0.375 AU} frequency plot with lowest intensity}

  \begin{center}
  \myfig{c_approx_ionization.ps}{.7}
  \end{center}
  \vspace{-20.00 truemm}
