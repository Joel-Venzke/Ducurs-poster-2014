...
\begin{minipage}[c][15cm][c]{0.78\textwidth}
  \begin{center}
    ...
    {\bf \LARGE  {\color{red} John Emmons, Sean Buczek, Joel Venzke, K. Bartschat,} and {\color{newgreen} A. N. Grum-Grzhimailo}\\[5mm]
...
\end{itemize}
  ...
  \begin{center}
  \myfig{c_spectrum_375_10_20_10_lowin.ps}{1.0}
  \end{center}
  \end{multicols}
  ...
  \begin{center}
  \myfig{c_spectrum_350_10_20_10_lowin.ps}{1.0}
  \end{center}
  \end{multicols}
