...
\vspace{1cm}\begin{center}\pbox{0.8\columnwidth}{}{linewidth=2mm,framearc=0.1,linecolor=lightblue,fillstyle=gradient,
  ...
  \vspace{-2cm}
  \mycaption{These plots illustrate that triplet effect depends on the intensity, not on the energy of the laser pulse. Note, this effect is only present for pulses ending with the $\sin^2$ envelope. This suggests the shape of the field at the end of the pulse is significant.}
