...
\begin{minipage}[c][15cm][c]{0.78\textwidth}
  \begin{center}
    ...
    {\bf \LARGE  {\color{red} Sean Buczek, John Emmons, Joel Venzke, K. Bartschat,} and {\color{newgreen} A. N. Grum-Grzhimailo}\\[5mm]
...
\vspace{0.375cm}\begin{center}\pbox{0.8\columnwidth}{}{linewidth=2mm,framearc=0.1,linecolor=lightblue,fillstyle=gradient,
 ...
 % \begin{multicols}{2}
 % \begin{center}
 % \myfig{c_pulse_350_20_0_20.ps}{.85}
 % \end{center}
 
 % \begin{center}
 % \myfig{c_fourier_350_20_0_20.ps}{.85}
 % \end{center}
 % \end{multicols}
