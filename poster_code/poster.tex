...
\begin{minipage}[c][15cm][c]{0.78\textwidth}
  \begin{center}
    ...
    {\bf \LARGE  {\color{red} Sean Buczek, Joel Venzke, John Emmons, K. Bartschat,} and {\color{newgreen} A. N. Grum-Grzhimailo}\\[5mm]
 ...
 {\bf \large Research Supported by the United States National Science Foundation under PHY-1430245}}
  \end{center}
\end{minipage}
%%% GK-Logo
\begin{minipage}[c][11cm][c]{0.1\textwidth}
...
% height between title and the first column
\vspace*{1.0cm}
...
%%% Introduction
\vspace{2.25cm}\begin{center}\pbox{0.8\columnwidth}{}{linewidth=2mm,framearc=0.1,linecolor=lightblue,fillstyle=gradient,gradangle=0,gradbegin=whiteblue,gradend=whiteblue,gradmidpoint=1.0,framesep=1em}{\begin{center}
{\Large\bf Introduction and Motivation}\end{center}}\end{center}\vspace{.75cm}
...
\vspace{1.5cm}\begin{center}\pbox{0.8\columnwidth}{}{linewidth=2mm,framearc=0.1,linecolor=lightblue,fillstyle=gradient,
                          gradangle=0,gradbegin=whiteblue,gradend=whiteblue,gradmidpoint=1.0,framesep=1em}{\begin{center}{\Large\bf The Stark Effect}\end{center}}\end{center}\vspace{.5cm}
...
\vspace{0.375cm}\begin{center}\pbox{0.8\columnwidth}{}{linewidth=2mm,framearc=0.1,linecolor=lightblue,fillstyle=gradient,
                          gradangle=0,gradbegin=whiteblue,gradend=whiteblue,gradmidpoint=1.0,framesep=1em}{\begin{center}{\Large\bf Field and Displacement}\end{center}}\end{center}
...
%\item This suggests {\bf\color{blue} interference effects between electrons ejected at different times}.
