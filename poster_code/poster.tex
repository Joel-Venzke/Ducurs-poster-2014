...
\vspace{1cm}\begin{center}\pbox{0.8\columnwidth}{}{linewidth=2mm,framearc=0.1,linecolor=lightblue,fillstyle=gradient,
                          gradangle=0,gradbegin=whiteblue,gradend=whiteblue,gradmidpoint=1.0,framesep=1em}{\begin{center}{\Large\bf The Problem}\end{center}}\end{center}\vspace{1.25cm}
...
\vspace{-2cm}
\mycaption{LEFT: Time to completion for analysis of a uniform filesystem tree with uniform branching factor two plotted with \emph{depth}. RIGHT: Time to completion for analysis of a uniform filesystem with branching factor two plotted with \emph{entry counts}.}
