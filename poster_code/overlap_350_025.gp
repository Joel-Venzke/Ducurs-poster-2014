...
set multiplot layout 2,0 title '\textbf{~~~~~~~~~\textbf{2-36-2~~~~$\mathbf{0.25 \times 10^{14}\,}$W/cm$^2$~~~~S-S}}'
...
#set format x '%4.2f'
set nolabel
set key at 17.75,.625 spacing 1.2
#set nokey
...
unset xtics
#set nokey
plot datadir . '/Pulse_s-s_2-36-2-350_0.2669/pulse.out' u 2:5 t '' w l lt 1 lc 3 lw 2
